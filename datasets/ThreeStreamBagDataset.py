...
class ThreeChannelBagDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # load from pt files
        if 'feature_path1' in self.df.columns:
            full_path1 = self.df['feature_path1'].values[idx]
        else:
        ...
        if 'feature_path2' in self.df.columns:
            full_path2 = self.df['feature_path2'].values[idx]
        else:
        ...
        if 'feature_path3' in self.df.columns:
            full_path3 = self.df['feature_path3'].values[idx]
        else:
